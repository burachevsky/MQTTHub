...
import com.github.burachevsky.mqtthub.core.connection.NotifyPayloadUpdate
...
class BrokerConnectionService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        applicationAs<BrokerConnectionServiceComponent.Provider>()
            .brokerConnectionServiceComponent()
            .inject(this)
