...
sealed class NotificationConfig(
    ...
    class Connected : NotificationConfig(
        textRes = R.string.mqtt_connection_service_message_connected,
        action = { context ->
            listOf(
                NotificationCompat.Action(
                    null,
                    context.getString(R.string.mqtt_connection_service_button_disconnect),
    ...
    class Connecting : NotificationConfig(
        textRes = R.string.mqtt_connection_service_message_connecting,
        action = null
    )

    class ConnectionFailed : NotificationConfig(
        textRes = R.string.mqtt_connection_service_message_connection_failed,
        action = { context ->
            listOf(
                NotificationCompat.Action(
                    null,
                    context.getString(R.string.mqtt_connection_service_button_retry),
                    PendingIntent.getService(
                        context,
                        0,
                        Intent(context, MqttService::class.java)
                ...
                NotificationCompat.Action(
                    null,
                    context.getString(R.string.mqtt_connection_service_button_dismiss),
                    PendingIntent.getService(
                        context,
                        0,
                        Intent(context, MqttService::class.java)
